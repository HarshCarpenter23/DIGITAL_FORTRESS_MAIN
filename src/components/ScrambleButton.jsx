...
const ScrambleButton = ({ text, onHover }) => {
  ...
  return (
    <motion.button
      className="md:text-[80px] text-[40px] border-2 rounded-full md:h-[191px] h-[170px] md:w-[750px] w-[350px] flex md:flex-row flex-col justify-center items-center"
    ...
    >
      <motion.span
        ...
        className=" w-full text-left ml-32"
      >
        {text}
      </motion.span>
